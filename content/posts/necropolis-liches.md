...
In delivery 0.10.0, all **3,333 installed files** matched the candidate; **2,323 previous nonmetadata files** are preserved, with 0.9.0 backed up. Final resource validation reports **188 informational findings, zero warnings and zero errors**. A fresh client reports successful mod loading. [Resource validation](/demos/necropolis-liches-01/validation.json) and [rig measurements](/images/necropolis-liches/measurements.json) accompany the gallery. No engine source changes are needed. Both new units still await user acceptance in the game.

[Vampire and Vampire Lord](/posts/necropolis-vampires/) were subsequently installed in 0.11.1. The 0.10.0 counts here remain the record of the lich delivery.
