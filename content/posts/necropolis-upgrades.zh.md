...
0.8.0 候选包加入这两种升级兵种，原有骷髅、行尸和高清背景文件保留不变。合包检查得到 **84 条信息、零错误、零警告**，[验证记录](/demos/necropolis-upgrades-01/validation.json)已公开。当前本地游戏安装仍是 0.7.0；本文发布的是候选包的离线预览，升级兵种尚未完成游戏内验收。
