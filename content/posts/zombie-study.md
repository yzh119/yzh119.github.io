...
![Panel comparison on the installed background, offline composite](/demos/necropolis-creatures-game-02/czombi-comparison.png)
...
used for review; the installed package also includes the effects described below.
