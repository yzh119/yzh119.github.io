...
The skeleton and walking dead now have reusable motion, placement, and showcase assets. This delivery added their upgrades: Skeleton Warrior (`CWSKEL`) and Zombie (`CZOMLO`). Both have a complete thirteen-clip render set, published here for review.
