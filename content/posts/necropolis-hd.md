...
The town uses **necropolis-layered-hd 0.3.0**; creature animations use **necropolis-creature-animations 0.12.1**. These version numbers belong to separate mods. This account reflects the installation checked on September 9, 2026.
...
The installed panel background reduces small rubble patterns and strengthens wall and crack shapes. The user accepted the composite comparison. A 1100×1430 master supplies two logical panel sizes at 1× through 4×, shared by Necropolis creatures.

![Installed backdrop and walking-dead placement, offline composite](/demos/necropolis-creatures-game-02/czombi-comparison.png)

[Current master](/demos/necropolis-creatures-game-02/background.png) · [Prompt](/demos/necropolis-creatures-game-02/background-prompt.txt). The earlier clarity feedback concerned the composite image; it did not establish an incorrect scale being loaded in the game.
