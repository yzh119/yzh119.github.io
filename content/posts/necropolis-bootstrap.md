...
## Rejected ghost and lich trials

After the procedural ghost and lich designs were rejected, the process moved to imagegen concepts, Meshy textured models and local rigging and animation. Rejected shapes, calibration mistakes and initial static meshes are retained below. The failed procedural prototypes were never installed.
