...
![Rejected cap bake under rear fill lighting; the brown-black patch remains visible in this actual Blender render](/images/castle-royal-griffin-2578/rejected-color.png)

The replacement samples the nearest same-side silver-feather surface for each cap texel and retains the wing material’s silver color treatment. It excludes body faces and avoids interpolating across unrelated regions of the source texture atlas. The following image uses the same camera and fill light as the rejected version. The color match improves, but the cap’s smooth surface remains conspicuous.
...
An **eight-frame hover interaction** now gives the head a small glance and relaxes the foreclaws before returning to the standing pose. Turning has two **three-frame halves**, with the game reversing the facing between them. <s>There are now twelve offline draft clips totaling 76 native frames. Death is still missing, and this set is not installed.</s> September 21: the death draft brings this to thirteen clips and 85 frames; the set remains uninstalled.
...
Death now has a **nine-frame draft**, matching the native sequence length: wing spread, loss of balance, a sideways fall, and wings settling toward the floor. The working set now contains thirteen clips and 85 native frames. Clip coverage does not mean the set has passed acceptance: feather intersections, landing timing, camera calibration and in-game playback remain open.

![Early death wing spread, actual 1000 × 1000 Blender still](/images/castle-royal-griffin-2774/spread.png)

![Sideways fall in the death draft, actual Blender still](/images/castle-royal-griffin-2774/fall.png)

![Resting draft after flattening the wing planes, actual Blender still; not installed](/images/castle-royal-griffin-2774/settled.png)

Across 257 sampled times, surface vertices remain finite, the first pose matches holding within 0.001 mm, and the largest floor penetration is about 0.007 mm. Grounding now considers only vertices referenced by faces. Orphan vertices left in the body mesh are excluded. This is still not a complete collision or contact test.

<details>
<summary>September 21: floating death trial</summary>

![Discarded trial: orphan vertices biased the floor calculation and lifted the visible corpse](/images/castle-royal-griffin-2774/rejected-floating.png)

The first pass used every vertex to find the lowest point. Leftover vertices with no faces lifted the visible model; changing the frame evaluation time did not fix it. After checking the topology, grounding was corrected, but the upright wings still propped the body up. Reducing the sideways roll produced a foreclaw-supported pose instead. The current draft retains the side fall and twists each wing around its long axis during settling. Overlapping upper feathers still need work.
...
![Open pose after partial remnant removal and alignment, actual 1200 × 1200 Blender still; shoulder joins remain unfinished](/images/castle-royal-griffin-2643/open.png)

![Intermediate backward sweep, actual Blender still; a complete native action set has not been authored](/images/castle-royal-griffin-2643/half.png)

![Front view at the end of the backward sweep, actual Blender still; local deformation and intersections need work](/images/castle-royal-griffin-2643/folded.png)

![Side view of the same pose; the visible shoulder opening prevents delivery acceptance](/images/castle-royal-griffin-2643/side-folded.png)
...
The first experiment bent the three joints sharply in opposing directions, producing a zigzag silhouette. A shoulder-led backward sweep produced the current candidate above, which still needs a more natural resting fold.

![Rejected large opposing joint rotations, actual Blender still](/images/castle-royal-griffin-2643/rejected-fold.png)

The earlier root-weight blend also stretched the wing locally during rotation. Its side view is retained below.

![Rejected root-weight blend, actual Blender still; sampled geometry showed severe local stretching](/images/castle-royal-griffin-2643/rejected-root-blend.png)

The pre-rigging record follows. **September 21 correction: the new wings now have an experimental rig and motion, and the body has undergone partial trimming. Statements about an unchanged body and unrigged wings apply only to this earlier version.**
...
<s>The current Royal Griffin study combines folded wings from an earlier Meshy model with the repaired standing body. These are **offline Blender renders**. The shoulder attachment remains open, medial feathers still have extraction cuts, and full wing unfolding is unfinished. This candidate has not been installed or accepted for appearance; all fourteen Castle creatures remain in production.</s>
...
| Pikeman | New silver-armor, blue-sleeve body and 24-bone rig generated; resting and elbow-probe renders completed. Fingers, pike, full actions and integration remain unfinished. Old-body thrust research preserved.<br>2026-09-26: the upright pike in the 0.14.1 draft's death is fixed (0.22.4). See [Castle cavalry and angels](/posts/castle-cavalry-angels/). |
...
| Cavalier | <s>Separate rider, horse and lance have a melee draft; grip, full horse attack and original cadence unresolved, not installed</s><br>2026-09-26: 13 groups, 81 frames installed as 1×/2× local test 0.17.1, with a new death and the original's left-side view. See [Castle cavalry and angels](/posts/castle-cavalry-angels/). |
| Angel | <s>Meshy humanoid rig, four local wing bones; 8-frame holding and 7-frame flight review accepted; <s>first sword rebind leaves a second vertical rest weapon and is rejected</s>; separate Meshy sword passes static review, but the matching unarmed-body candidate has perforated wings and is rejected</s><br>2026-09-26: the old model was off-likeness and was rebuilt from a new concept; 13 groups, 94 frames installed (0.18.0; 0.18.1 with rebuilt wings, 26 September). See [Castle cavalry and angels](/posts/castle-cavalry-angels/). |
...
| Royal Griffin | <s>New flight-specific Meshy mesh has flight, front pounce, hit and defence trials; directional attacks, death, full layers and integration unfinished</s><br>2026-09-22 correction: the 13-clip, 85-frame draft is installed as private test 0.15.0. Mod startup loading was verified; battle behavior, wing intersections and appearance remain unaccepted.<br>2026-09-26: palette corrected to the original's silver-grey feathers and brown lion body. See [Castle cavalry and angels](/posts/castle-cavalry-angels/). |
...
| Champion | <s>Mounted gait and skin-weight repair remain experimental; version26 rejected, with local joint deformation and original gait still unresolved in version25; not installed</s><br>2026-09-26: now uses the Cavalier's rig and motion with plume, eagle shield and horse armour; 13 groups, 81 frames installed (0.20.0). See [Castle cavalry and angels](/posts/castle-cavalry-angels/). |
| Archangel | <s>Separate Meshy sword with a local-wing humanoid rig; holding, 7-frame flight, three 6-frame sword attacks, 10-frame defence, 6-frame hit, and move transitions accepted in review</s><br>2026-09-26: rebuilt on a new model; 13 groups, 91 frames installed (0.19.0; 0.19.1 with rebuilt wings). See [Castle cavalry and angels](/posts/castle-cavalry-angels/). |
